"""ams_guidance_databa_17491 URL Configuration
...
admin.site.site_header = "AMS Guidance Database"
admin.site.site_title = "AMS Guidance Database Admin Portal"
admin.site.index_title = "AMS Guidance Database Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="AMS Guidance Database API",
        default_version="v1",
        description="API documentation for AMS Guidance Database App",
    ),
    public=True,
